...
This prompt guides you through a complete 7-step A workflow using MCP servers and Al agents to go from user story to committed automated test scripts.
...
3. Create a comprehensive test plin that covers all acceptance criteria including:
...
6. ⁠Document:
- Initial test results (pass/fall count)
- Healing actiyities performed
...
* Healed test scripts updated in tests/saucedemo-checkout/Heal/
...
-Bug ID
-Severity (criterial/High/Medium/low)
...
Git Repository URL: https://github.com/swagatsethi96-debug/PlayWrightwithJenkinsDemo.git
...
2. Stage all files in the workspace (all new and modified f11es)
...
Run all automation scripts from tests/saucedemo-checkout/Heal/. Use the playwright-test-healer agent to identify and auto-heal any failing tests. Re-run tests until all are stable and passing, Document healing activities.
...
## 🔥 ENHANCED ADDITIONAL STEPS (ADDED FOR ENTERPRISE QA)

### STEP 8: CI/CD Integration (Jenkins)
...
### STEP 10: Test Data Strategy

- Use Faker for dynamic data
- Maintain test-data folder
- Handle environment-specific configs

---

### STEP 11: Stability & Flaky Test Handling

- Retry strategy
- Smart waits
- Network mocking (if needed)
...
- Full QA lifecycle coverage
- Manual + Automation synergy
- CI/CD integration
